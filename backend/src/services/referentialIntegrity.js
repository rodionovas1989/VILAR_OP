...
const COLLECTION_LABELS = {
  ...
  stock: 'Запасы',
  active_reservations: 'Резервы',
  reservation_history: 'Резервы (ист)',
  material_movements: 'Запасы (ист)',
  production_register: 'Аналитика производства',
  quality_documents: 'Управление качеством',
  quality_register: 'Качества партий',
  quality_history: 'Качества партий (ист)',
  characteristic_documents: 'Управление характеристиками',
  characteristic_register: 'Характеристики партий',
  characteristic_history: 'Характеристики партий (ист)',
  ...Object.fromEntries(
