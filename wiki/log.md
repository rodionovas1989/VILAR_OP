...
`suggestPicksBulk` с виртуальным claimed партия×склад; UI: фильтр «Только проблемные» по заказам (✗ или предупреждения); кнопка «Следующая проблема» убрана. Analysis «хвосты партий» отложен (G9).
