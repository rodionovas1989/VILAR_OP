...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    label: 'Качество',
    items: [
      { id: 'quality_documents', label: 'Документы качества', kind: 'quality' },
      { id: 'quality_register', label: 'Регистр качества', kind: 'quality' },
      { id: 'quality_history', label: 'История качества', kind: 'quality' },
    ],
  },
  {
    id: 'admin',
