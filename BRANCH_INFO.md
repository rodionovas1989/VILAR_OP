...
|-------|----------|--------|
| `main` | + уникальность партий + toast ошибок (FB-00007) | **эталон** |
| `feature/fb-00002-approved-suppliers-analogues` | Поставщики↔аналоги + лента «Что нового» | **активна** |
| `feature/fb-00007-lot-uniqueness` | Уникальность номера/ид. номера партии (FB-00007) | **слита** в main |
| `feature/fb-00005-lot-identification-number` | Партия: идентификационный номер (FB-00005) | **слита** в main |
