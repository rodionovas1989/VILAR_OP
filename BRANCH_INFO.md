...
| `fix/admin-login-no-hint-strong-password` | Без подсказки Admin в UI; пароль Admin через `VILAR_ADMIN_PASSWORD` | **активна** |
...
| `feature/planned-series-volumes` | Плановые объёмы серий | слита в main |
| `feature/spec-approved-suppliers` | Регистрация поставщиков | слита в main |
| `feature/admin-export-dictionaries` | Экспорт справочников | слита в main |
| `feature/crud-ux-spec-type-filters` | Отборы; тип спецификации | слита в main |
